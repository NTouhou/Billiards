...
/**
 * Write a description of class tokuten_ball6 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tokuten_ball6 extends bound_ball
{
    /**
     * Act - do whatever the tokuten_ball6 wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    static int tokuten_rotation;
    static double tokuten_speed;
    
    public tokuten_ball6(){
        tokuten_speed = 0;
        tokuten_rotation = 0;
    }
