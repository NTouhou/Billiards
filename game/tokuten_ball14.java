...
/**
 * Write a description of class tokuten_ball14 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tokuten_ball14 extends bound_ball
{
    /**
     * Act - do whatever the tokuten_ball14 wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    static int tokuten_rotation;
    static double tokuten_speed;
    
    public tokuten_ball14(){
        tokuten_speed = 0;
        tokuten_rotation = 0;
    }
