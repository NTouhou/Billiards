...
/**
 * Write a description of class tokuten_ball7 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tokuten_ball7 extends bound_ball
{
    /**
     * Act - do whatever the tokuten_ball7 wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    static int tokuten_rotation;
    static double tokuten_speed;
    
    public tokuten_ball7(){
        tokuten_speed = 0;
        tokuten_rotation = 0;
    }
