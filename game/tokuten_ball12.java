...
/**
 * Write a description of class tokuten_ball12 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tokuten_ball12 extends bound_ball
{
    /**
     * Act - do whatever the tokuten_ball12 wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    static int tokuten_rotation;
    static double tokuten_speed;
    
    public tokuten_ball12(){
        tokuten_speed = 0;
        tokuten_rotation = 0;
    }
